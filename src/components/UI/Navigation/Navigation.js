...
const Navigation=(props)=>{
        const {setmodal, tab, settab}= props;

    return(
        <ul>
        <li onClick={()=>settab('sells')}><NavLink to="/">
