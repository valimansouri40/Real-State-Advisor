...
const Header= (props)=>{
        ...
        return(
            ...
            {modal && !modal2?<Modal setmodal={setmodal}><div class="modal fade" id="exampleModal2" >
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form onSubmit={submithandller}>
                                <input type="text" onChange={(e)=>setName(e.target.value)} placeholder="نام و نام خانوادگی"/>
            ...
            {modal2 && !modal? <Modal setmodal={setmodal2}><div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
